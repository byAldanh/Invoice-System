...
<!--Handling the session that will be created from the products controller--> 
@if(session()->has('Add'))
                                ...
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <select name="section_id" id="section_id" class="form-control" required>
											...
											<!-- the id of the section will be stored, not the name itself--> 
                                           @foreach ($sections as $section)
                                                <option value="{{ $section->id }}">{{ $section->section_name }}</option>  <!-- the value is the id to be stored--> 
                                            @endforeach
                                        </select>
...
<script>
	// to view the information in the form of the edit modal 
