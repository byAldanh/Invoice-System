			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">قائمة الفواتير </a></li> <!-- all of the invoices, (paied, not paied ) --> 
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='sections') }}"> الاقسام </a></li> <!-- move to the 'sections' route, then from the route it will move to the index method in the sections controller --> 
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}"> المنتجات </a></li><!-- move to the 'products' route, then from the route it will move to the index method in the products controller --> 
						</ul>
					</li>
